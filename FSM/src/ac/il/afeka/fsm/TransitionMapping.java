...
public abstract class TransitionMapping {
	 ...
	 *
	 * @param states
	 *            the states of the state machine that holds this mapping
	 * @param alphabet
	 *            the alphabet of the state machine that holds this mapping
	 * @throws Exception
	 *             if it finds a transition with a state that does not belong to the
	 *             machine or a symbol that does not belong to the machine's
	 *             alphabet.
	 */
